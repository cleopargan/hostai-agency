...
const plans = [
  {
    ...
    description: "Perfect for hotels that want to start with high-intent demand capture through Google and Bing.",
    features: [
      "Google Ads & Bing campaign management",
      "Keyword research & bid control",
      "Hotel Ads setup & optimisation",
      "Conversion tracking",
      "Weekly performance reporting",
      "Dedicated account support",
    ],
    notIncluded: ["SEO & Global Search", "Direct Booking AI", "Digital Concierge"],
    cta: "Start With Paid Search",
    popular: false,
    color: "#4A90E2",
  ...
  },
  {
    ...
    description: "The full acquisition stack: demand capture plus SEO and AI conversion tools that lift direct-booking performance.",
    features: [
      "Everything in Starter",
      "SEO & Global Search setup",
      "Location page creation & technical SEO",
      "Direct Booking AI conversion layer",
      "Monthly strategy reviews",
      "Priority support",
    ],
    notIncluded: ["Digital Concierge", "CEO Command Center"],
    cta: "Start Growing",
    popular: true,
    color: "#C9A84C",
  ...
  },
  {
    ...
    description: "A complete hotel growth system covering paid search, SEO, AI conversion, concierge automation, and leadership reporting.",
    features: [
      "Everything in Growth",
      "Digital Concierge automations",
      "Guest messaging, upsells & review collection",
