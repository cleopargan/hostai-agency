/* ============================================================
   NAVBAR — Elite Luxury v4
   - Marquee announcement bar with gold gradient
   - Transparent → deep glass on scroll with blur
   - Cormorant wordmark + hexagon icon
   - Refined nav links with animated gold underline
   - "Book Free Demo" CTA with live indicator
   ============================================================ */
