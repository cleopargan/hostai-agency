...
export default function SmallHotelChains() {
    ...
    <div className="min-h-screen" style={{ background: "#0A0A0F", color: "#F5F0E8" }}>
      ...
      <div style={{ paddingTop: "8rem", paddingBottom: "4rem", maxWidth: "800px", margin: "0 auto", paddingLeft: "1.5rem", paddingRight: "1.5rem" }}>
        ...
        <h1 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: "3rem", fontWeight: 600, marginBottom: "1rem", lineHeight: 1.1 }}>
          NightDesk for Small Hotel Chains
        </h1>
        <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "1.1rem", color: "rgba(245,240,232,0.6)", marginBottom: "3rem", lineHeight: 1.7 }}>
          AI receptionist, Google Ads, and direct booking optimization designed specifically for small hotel chains with 2–10 properties rooms.
        </p>
        <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "1.05rem", lineHeight: 1.9, color: "rgba(245,240,232,0.8)" }}>
          <h2 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: "1.9rem", fontWeight: 600, color: "#F5F0E8", marginBottom: "1rem", marginTop: "2.5rem" }}>The Small Hotel Chains Challenge</h2>
          <p style={{ marginBottom: "1.5rem" }}>Small hotel chains with 2 to 10 properties face a scaling challenge: each property has its own OTA dependency problem, but managing a separate direct booking strategy for each property is complex and expensive. Many small chains end up with inconsistent approaches across properties — some with decent direct booking channels, others almost entirely OTA-dependent. This inconsistency makes it difficult to build a coherent brand and direct booking strategy across the portfolio.</p>
          ...
          <p style={{ marginBottom: "1.5rem" }}>NightDesk can manage the AI Receptionist, Google Ads, and Direct Booking Optimization for multiple properties under one account, with each property's AI trained on its specific information. This allows small chains to implement a consistent direct booking strategy across all properties while maintaining the unique character of each property. NightDesk offers custom pricing for multi-property clients — contact us for a portfolio audit.</p>
          ...
          <div style={{ marginTop: "3rem", padding: "2rem", background: "rgba(201,168,76,0.06)", border: "1px solid rgba(201,168,76,0.2)", borderRadius: "12px", textAlign: "center" }}>
            ...
            <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "0.95rem", color: "rgba(245,240,232,0.7)", marginBottom: "1.5rem" }}>See exactly how much revenue your small hotel chains could recover from OTAs.</p>
