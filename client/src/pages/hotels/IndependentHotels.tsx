    ...
    <div className="min-h-screen" style={{ background: "#0A0A0F", color: "#F5F0E8" }}>
      ...
      <div style={{ paddingTop: "8rem", paddingBottom: "4rem", maxWidth: "800px", margin: "0 auto", paddingLeft: "1.5rem", paddingRight: "1.5rem" }}>
        ...
        <h1 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: "3rem", fontWeight: 600, marginBottom: "1rem", lineHeight: 1.1 }}>
          NightDesk for Independent Hotels
        </h1>
        <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "1.1rem", color: "rgba(245,240,232,0.6)", marginBottom: "3rem", lineHeight: 1.7 }}>
          AI receptionist, Google Ads, and direct booking optimization designed specifically for independent hotels with 30–150 rooms.
        </p>
        <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "1.05rem", lineHeight: 1.9, color: "rgba(245,240,232,0.8)" }}>
          <h2 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: "1.9rem", fontWeight: 600, color: "#F5F0E8", marginBottom: "1rem", marginTop: "2.5rem" }}>The Independent Hotels Challenge</h2>
          <p style={{ marginBottom: "1.5rem" }}>Independent hotels with 30 to 150 rooms are in a particularly difficult competitive position. They are large enough to have significant OTA commission costs — often $5,000 to $15,000 per month — but not large enough to have in-house marketing teams or enterprise technology budgets. They compete with both large chains (which have loyalty programs and massive marketing budgets) and OTAs (which dominate Google search results). Without a systematic direct booking strategy, independent hotels are essentially subsidizing their competitors.</p>
          ...
          <p style={{ marginBottom: "1.5rem" }}>NightDesk gives independent hotels the same capabilities that large chains use to drive direct bookings — AI technology, Google Ads expertise, and conversion optimization — at a price point designed for independent properties. The AI Receptionist handles the volume of inquiries that a 50–150 room hotel generates without requiring additional staff. Google Ads campaigns compete effectively for direct booking traffic even against OTA budgets. Direct Booking Optimization ensures that the traffic NightDesk drives actually converts into bookings.</p>
          ...
          <div style={{ marginTop: "3rem", padding: "2rem", background: "rgba(201,168,76,0.06)", border: "1px solid rgba(201,168,76,0.2)", borderRadius: "12px", textAlign: "center" }}>
            ...
            <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "0.95rem", color: "rgba(245,240,232,0.7)", marginBottom: "1.5rem" }}>See exactly how much revenue your independent hotels could recover from OTAs.</p>
